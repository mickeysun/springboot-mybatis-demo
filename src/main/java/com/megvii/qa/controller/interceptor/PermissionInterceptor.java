package com.megvii.qa.controller.interceptor;

import com.megvii.qa.core.conf.QaTestAdminConfig;
import com.megvii.qa.controller.annotation.PermessionLimit;
import com.megvii.qa.core.util.CookieUtil;
...
public class PermissionInterceptor extends HandlerInterceptorAdapter {
	...
	public static String getLoginIdentityToken() {
		if (LOGIN_IDENTITY_TOKEN == null) {
			String username = QaTestAdminConfig.getAdminConfig().getLoginUsername();
			String password = QaTestAdminConfig.getAdminConfig().getLoginPassword();
